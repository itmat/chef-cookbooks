...
recipe            "apache2::mod_xsendfile", "Apache module 'XSendFile' with config file"
...
attribute "apache/xsendfile",
  :display_name => "Apache XSendFile",
  :description => "Whether to enable the X-SENDFILE header [on|off]",
  :default => "on"

attribute "apache/xsendfile_allow_above",
  :display_name => "Apache XSendFileAllowAbove",
  :description => "Whether to allow X-SENDFILE to access files above the request root [on|off]",
  :default => "off"
